    ...
    <div className="widgetLg">
      ...
      <table className="widgetLgTable">
        <tr className="widgetLgTr">
          <th className="widgetLgTh">Students</th>
          <th className="widgetLgTh">Course Name</th>
        ...
        <tr className="widgetLgTr">
          ...
          <td className="widgetLgCourse">Javascript- From Zero to Hero</td>
          <td className="widgetLgDate">14 Jan 2023</td>
        ...
        <tr className="widgetLgTr">
          ...
          <td className="widgetLgCourse">React- The complete guide</td>
          <td className="widgetLgDate">12 Jan 2023</td>
          <td className="widgetLgAmount">$19.00</td>
          <td className="widgetLgStatus">
        ...
        <tr className="widgetLgTr">
          ...
          <td className="widgetLgCourse">Influence - Psychology of Persuasion</td>
          <td className="widgetLgDate">11 Jan 2023</td>
        ...
        <tr className="widgetLgTr">
          ...
          <td className="widgetLgCourse">Financial Markets - A Comprehensive Guide</td>
          <td className="widgetLgDate">9 Jan 2023</td>
          <td className="widgetLgAmount">$25.00</td>
          <td className="widgetLgStatus">
            <Button type="Approved" />
          </td>
