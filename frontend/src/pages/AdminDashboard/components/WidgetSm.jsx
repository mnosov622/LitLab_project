...
function WidgetSm() {
  return (
    <div className="widgetSm">
      <span className="widgetSmTitle">New Joined Instructors</span>
      <ul className="widgetSmList">
        ...
        <li className="widgetSmListItem">
          ...
          <div className="widgetSmUser">
            ...
            <span className="widgetSmUserTitle">Python Expert</span>
          </div>
          <button className="widgetSmButton">
            <button className="widgetSmIcon" />
            Display Info
        ...
        <li className="widgetSmListItem">
          ...
          <div className="widgetSmUser">
            ...
            <span className="widgetSmUserTitle">Bootstrap Expert</span>
          </div>
          <button className="widgetSmButton">
            <button className="widgetSmIcon" />
            Display Info
